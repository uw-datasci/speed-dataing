              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-600">
                    View all speed dataing matches generated by the algorithm.
                  </p>
                </div>
              </div>
              ...
              {matches.length === 0 ? (
                <div className="bg-white rounded-lg shadow-lg p-12 text-center border-2 border-[#374995]">
                  ...
                  <p className="text-gray-600 mb-6">
                    No current matches have been generated yet. Run the matching algorithm to
                    create matches.
                  </p>
                  <button
                    onClick={() => router.push("/admin")}
                ...
                <>
                  <div className="bg-white rounded-lg shadow-lg p-6 border-2 border-[#374995]">
                    ...
                    <p className="text-gray-600">
                      Generated on:{" "}
                      {matches.length > 0 ? formatDate(matches[0].created_at) : "N/A"}
                    </p>
                  </div>
                      ...
                      >
                        ...
                        <div className="bg-[#374995] p-6 text-center">
                          ...
                          <div className="text-white text-sm">
                            Match #{index + 1} • {(match.similarity_score * 100).toFixed(1)}%
                            Similarity
                          </div>
                        </div>
                            ...
                            <div className="border-b border-gray-200 pb-4">
                              ...
                              {match.person1 ? (
                                <div className="space-y-1 text-sm">
                                  ...
                                  <p>
                                    <strong>Program:</strong> {match.person1.program}
                                  </p>
                                  <p>
                                    <strong>Pronouns:</strong> {match.person1.pronouns}
                                  </p>
                                  <p>
                                    <strong>Socials:</strong> {match.person1.social_media_links}
                                  </p>
                                </div>
                              ) : (
                            ...
                            <div>
                              ...
                              {match.person2 ? (
                                <div className="space-y-1 text-sm">
                                  ...
                                  <p>
                                    <strong>Program:</strong> {match.person2.program}
                                  </p>
                                  <p>
                                    <strong>Pronouns:</strong> {match.person2.pronouns}
                                  </p>
                                  <p>
                                    <strong>Socials:</strong> {match.person2.social_media_links}
                                  </p>
                                </div>
                              ) : (
                                <p className="text-gray-500 text-sm">
